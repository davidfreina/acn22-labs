...
servers = bcupe.servers.copy()
random.shuffle(servers)

links = {}
# start = time()

permutations = list(zip(bcupe.servers, servers, itertools.repeat(
    (bcupe.switches + bcupe.servers)), itertools.repeat(64)))
