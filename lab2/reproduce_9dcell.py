...
servers = dcell.servers.copy()
random.shuffle(servers)

links = {}
# start = time()

permutations = list(zip(dcell.servers, servers, itertools.repeat(
    (dcell.switches + dcell.servers)), itertools.repeat(64)))
